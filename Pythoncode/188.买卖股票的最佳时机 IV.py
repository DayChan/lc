class Solution:
    ...
    def maxProfit(self, k: int, prices: List[int]) -> int:
        ...
        return self.getmaxProfit(prices, len(prices)-1, k, 0, dp)
    def getmaxProfit(self, prices, a, b, c, dp):
        ...
        if (a, b, c) in dp:
           pass
            ...
            p2 = self.getmaxProfit(prices, a-1, b-1, 0, dp) - prices[a] #第a-1天结束时就还没有持有股票，第a天才买入股票，所以从第0天开始到第a-1天结束，只能至多进行了b-1次买入
            dp[(a, b, c)] = max(p1, p2)
        else: #第a天结束时不持有股票
